var Vue = (function (exports) {
  ...
  function createGetter(isReadonly = false, shallow = false) {
    return function get(target, key, receiver) {
      ...
      return isObject(res) ?
        isReadonly ? // need to lazy access readonly and reactive here to avoid
        // circular dependency
        readonly(res) :
        reactive(res) :
        res;
  ...
  function customRef(factory) {
    const {
      get,
      set
    } = factory(() => track(r, "get" /* GET */ , 'value'), () => trigger(r, "set" /* SET */ , 'value'));
    const r = {
      __v_isRef: true,
      get value() {
        return get();
  ...
  function warn(msg, ...args) {
    ...
    if (appWarnHandler) {
      callWithErrorHandling(appWarnHandler, instance, 11 /* APP_WARN_HANDLER */ , [
        ...
        .map(({
          vnode
        }) => `at <${formatComponentName(vnode.type)}>`)
        .join('\n'),
        trace
      ]);
    } else {
  ...
  function renderSlot(slots, name, props = {},
    ...
    return (openBlock(),
      createBlock(Fragment, {
        key: props.key
      }, slot ? slot(props) : fallback ? fallback() : [], slots._ ? 64 /* STABLE_FRAGMENT */ : -2 /* BAIL */ ));
  }
